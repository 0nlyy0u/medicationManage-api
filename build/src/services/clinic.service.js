      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _clinic.ClinicModel.createNew(data);

          case 3:
            createdPK = _context.sent;
            _context.next = 6;
            return _clinic.ClinicModel.findOneById(createdPK.insertedId.toString());
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 6;
            return _clinic.ClinicModel.update(id, updateData);
...
var deleteClinic = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _clinic.ClinicModel.deleteClinic(id);
  ...
  return function deleteClinic(_x3) {
...
var getListClinics = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.prev = 2;
            _context4.next = 5;
            return _clinic.ClinicModel.getListClinics(parseInt(page), parseInt(itemPerpage));

          case 5:
            results = _context4.sent;

            if (results.clinics.length > 0) {
              results.clinics.map(function (elm, idx) {
  ...
  return function getListClinics() {
