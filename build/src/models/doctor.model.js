...
var doctorCollectionName = 'doctors';

var boardCollectionSchema = _joi["default"].object({
  name: _joi["default"].string().required().min(1).max(50).trim(),
  workPlace: _joi["default"].string().min(10).max(256).trim(),
  phone: _joi["default"].string().required().min(10).max(50).trim(),
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return (0, _mongodb2.getDB)().collection(doctorCollectionName).findOne({
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            _context3.next = 6;
            return (0, _mongodb2.getDB)().collection(doctorCollectionName).insertOne(createData);
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 5;
            return (0, _mongodb2.getDB)().collection(doctorCollectionName).findOneAndUpdate({
              _id: (0, _mongodb.ObjectId)(id)
            }, {
              $set: updateData
            }, {
...
var deleteDoctor = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return (0, _mongodb2.getDB)().collection(doctorCollectionName).deleteOne({
  ...
  return function deleteDoctor(_x6) {
...
var getListDoctors = /*#__PURE__*/function () {
  var _ref6 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6(page, itemPerpage) {
    var _res$totalDoctor$, queryConditions, query, res;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.next = 4;
            return (0, _mongodb2.getDB)().collection(doctorCollectionName).aggregate([{
              $match: {
                $and: queryConditions
              }
            }, {
          ...
          case 4:
            ...
            return _context6.abrupt("return", {
              doctors: res.doctors || [],
              totalDoctor: ((_res$totalDoctor$ = res.totalDoctor[0]) === null || _res$totalDoctor$ === void 0 ? void 0 : _res$totalDoctor$.countedDoctors) || 0
            });
  ...
  return function getListDoctors(_x7, _x8) {
...
var DoctorModel = {
  ...
  doctorCollectionName: doctorCollectionName,
